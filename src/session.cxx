...
HSession::HSession( HString const& remoteAddr_ , HString const& httpUserAgent_ )
	: _id( tools::hash::sha1( remoteAddr_ + httpUserAgent_ + HTime( HTime::UTC ).string() + randomizer_helper::make_randomizer()() ) ),
	_user(), _groups(), _remoteAddr( remoteAddr_ ), _httpUserAgent( httpUserAgent_ ), _lastSeen( HTime::UTC ), _persistance()
	{}
